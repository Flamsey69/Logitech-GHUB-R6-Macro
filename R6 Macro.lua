...
SMGRecoilMouseMoveAmount    = 6  --           // distance the mousewill move down for recoil compensation NO decimals
...
LockKey = "scrolllock"             --    // (TURNS ENTIRE SCRIPT ON/OFF) 
--                                    // Options for binding include "scrolllock" "capslock" and "numlock" 
 
SMGorARtoggle = "capslock"    --    // alternates between ARs and SMGs 
